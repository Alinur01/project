...
def make_operation_button(operation):
    return tk.Button(text=operation, bd=5, font=('Arial', 15), fg='blue',
...
tk.Button(text='1', bd=5, font=('Arial', 15), command=lambda: add_digit(1)).\
    grid(row=1, column=0, stick='wens', padx=5, pady=5)
tk.Button(text='2', bd=5, font=('Arial', 15), command=lambda: add_digit(2)).\
    grid(row=1, column=1, stick='wens', padx=5, pady=5)
tk.Button(text='3', bd=5, font=('Arial', 15), command=lambda: add_digit(3)).\
    grid(row=1, column=2, stick='wens', padx=5, pady=5)
tk.Button(text='4', bd=5, font=('Arial', 15), command=lambda: add_digit(4)).\
    grid(row=2, column=0, stick='wens', padx=5, pady=5)
tk.Button(text='5', bd=5, font=('Arial', 15), command=lambda: add_digit(5)).\
    grid(row=2, column=1, stick='wens', padx=5, pady=5)
tk.Button(text='6', bd=5, font=('Arial', 15), command=lambda: add_digit(6)).\
    grid(row=2, column=2, stick='wens', padx=5, pady=5)
tk.Button(text='7', bd=5, font=('Arial', 15), command=lambda: add_digit(7)).\
    grid(row=3, column=0, stick='wens', padx=5, pady=5)
tk.Button(text='8', bd=5, font=('Arial', 15), command=lambda: add_digit(8)).\
    grid(row=3, column=1, stick='wens', padx=5, pady=5)
tk.Button(text='9', bd=5, font=('Arial', 15), command=lambda: add_digit(9)).\
    grid(row=3, column=2, stick='wens', padx=5, pady=5)
tk.Button(text='0', bd=5, font=('Arial', 15), command=lambda: add_digit(0)).\
